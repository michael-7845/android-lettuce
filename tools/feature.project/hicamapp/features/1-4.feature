...
特性: 1主页（HA010001）-4HiCam设置入口
    ...
    场景: 1有网络
        ...
        9、进入HiCam设置:点击页面元素【resourceId=com.hicamapp:id/btn_settings】
        10、检查是否正常进入HiCam设置:应该可看到页面元素【resourceId=com.hicamapp:id/container_settings_back】
    ...
    场景: 2无网络
        ...
        5、验证无法进入控制器查看不了设置:应该看不到页面元素【resourceId=com.hicamapp:id/btn_settings】