...
@before_feature_of(u"7收看视频直播（HA0106)-2主界面入口（HA010602）-1")
...
@after_feature_of(u"7收看视频直播（HA0106)-2主界面入口（HA010602）-1")
...
@before_scenario_in_feature_of(u"7收看视频直播（HA0106)-2主界面入口（HA010602）-1")
def before_scenario_SettingsEnter(scenario):
    pass

@after_scenario_in_feature_of(u"7收看视频直播（HA0106)-2主界面入口（HA010602）-1") 
